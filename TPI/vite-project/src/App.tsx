...
const ProtectedRoute: React.FC<{
  ...
  empleadoPage?: React.ReactNode;
  isEmpleadoOnly?: boolean;
}> = ({ children, empleadoPage, isEmpleadoOnly }) => {
        ...
        <div>
          <Routes>
            ...
            <Route
              path="/hechizos"
              element={
                <ProtectedRoute empleadoPage={<HechizosEmpleadoPage />}>
                  <HechizosPage />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/patentes"
              element={
                <ProtectedRoute empleadoPage={<PatentesEmpleadoPage />}>
                  <PatentesPage />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/visualizacion"
              element={
                <ProtectedRoute empleadoPage={<VisualizacionEmpleadoPage />}>
                  <VisualizacionPage />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/instituciones"
              element={
                <ProtectedRoute isEmpleadoOnly={true}>
                  <InstitucionesPage />
                </ProtectedRoute>
              }
            />
