import { Entity, OneToMany, PrimaryKey, Property, Cascade, Collection, ManyToOne, ManyToMany, OneToOne } from "@mikro-orm/core"
...
export class Hechizo extends BaseEntity{
    ...
    @Property({nullable: false, unique: false})
    restringido!: boolean
    @OneToOne(() => Patente, patente => patente.hechizo, {owner:true})
    patente!: Patente
